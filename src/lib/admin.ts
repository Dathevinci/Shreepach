...
// Admins are a fixed, max-level role — they hold a sensible fixed Arise Points
// balance rather than huge legacy override values. The Lead Dev shows ∞.
export const ADMIN_ARISE_POINTS = 1000;
