...
export function AvatarDecoration({
  ...
  frame?: string | null;
  effect?: string | null;
  // "lg" = the big profile avatar (full-fidelity heavy effects). "sm" = every
  // other, denser surface (comments, directory, lists, nav, shop) where heavy
  // effects collapse to a cheap glow so a page full of avatars stays smooth.
  size?: "sm" | "lg";
}) {
